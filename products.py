    ...
    def product_menu():
        while True:
            ...
            if choice == '1':
                ...
                description = input("Enter product description (leave blank to skip): ")
                price_input = input("Enter product price (leave blank to skip): ")
                price = float(price_input) if price_input else None
                quantity_input = input("Enter product quantity (leave blank to skip): ")
